...
// API Path
$context->set_path('/sandbox/ipg/v2/vodafoneLES/getSession/');
...
$context->set_address('openapi.m-pesa.com');
$context->set_port(443);
$context->set_path('/sandbox/ipg/v2/vodafoneLES/directDebitCreation/');

$context->add_header('Origin', '*');

$context->add_parameter('input_AgreedTC', '1');
$context->add_parameter('input_Country', 'LES');
$context->add_parameter('input_CustomerMSISDN', '000000000001');
$context->add_parameter('input_EndRangeOfDays', '22');
$context->add_parameter('input_ExpiryDate', '20161126');
$context->add_parameter('input_FirstPaymentDate', '20160324');
$context->add_parameter('input_Frequency', '04');
$context->add_parameter('input_ServiceProviderCode', '000000');
$context->add_parameter('input_StartRangeOfDays', '01');
$context->add_parameter('input_ThirdPartyConversationID', 'asv02e5958774f7ba228d83d0d689761');
$context->add_parameter('input_ThirdPartyReference', '3333');
