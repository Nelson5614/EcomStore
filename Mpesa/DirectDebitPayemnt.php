...
// API Path
$context->set_path('/sandbox/ipg/v2/vodafoneGHA/getSession/');
...
$context->set_address('openapi.m-pesa.com');
$context->set_port(443);
$context->set_path('/sandbox/ipg/v2/vodafoneGHA/directDebitPayment/');
...
$context->add_parameter('input_ThirdPartyReference', '5db410b459bd433ca8e5');
$context->add_parameter('input_MandateID', '15045');
