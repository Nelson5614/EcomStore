            ...
            <div class="bg-gradient-to-r from-amber-500 to-amber-600 text-white py-12">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="text-center">
                        <h1 class="text-3xl sm:text-4xl font-bold mb-4">{{ category.name }}</h1>
                        <p class="text-lg sm:text-xl opacity-90">Browse our collection of {{ category.name.toLowerCase() }}</p>
                    </div>
                </div>
            </div>
