...
const editProductModal = (product) => {
    ...
    is_published.value = product.is_published;
                ...
                >
                    ...
                    >
                        <button
                            ...
                            class="flex items-center justify-center text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800"
                        >
                            <svg
                    ...
                    >
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td class="px-4 py-3">M{{ product.price }}</td>
                                <td class="px-4 py-3">
                                    <span
                                    ...
                                    >
                                        ...
                                        >
                                            <li>
                                                <button
                                                    ...
                                                    "
                                                    class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white w-full text-start"
                                                >
                                                    Edit
                                                </button>
                                            </li>
                                        ...
                                        <div class="py-1">
                                            <button
                                                ...
                                                class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 w-full text-start dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white"
                                            >
                                                Delete
                                            </button>
                                        </div>
