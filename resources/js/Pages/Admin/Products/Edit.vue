          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="space-y-6">
              ...
              <div>
                ...
                <!-- Existing Images -->
                <div v-if="product.product_images && product.product_images.length > 0" class="mt-4 grid grid-cols-3 gap-4">
                  <div v-for="(image, index) in product.product_images" :key="image.id" class="relative">
                    <img :src="`/storage/${image.path}`" class="h-24 w-24 object-cover rounded-lg" />
                    <button
                      type="button"
