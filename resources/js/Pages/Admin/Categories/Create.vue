    ...
    <div class="p-4 sm:p-6">
      <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4 sm:mb-6">
        <div class="mb-4 sm:mb-0">
          ...
          <p class="text-sm sm:text-base text-gray-600">Add a new category to your store</p>
        </div>
        <Link
        ...
        <form @submit.prevent="submit" class="p-4 sm:p-6">
          <div class="grid grid-cols-1 gap-4 sm:gap-6">
            ...
            <div>
              ...
              />
              <p class="mt-1 text-sm text-gray-500">This will be automatically generated from the category name.</p>
            </div>
            ...
            <div>
              ...
              <p class="mt-1 text-sm text-gray-500">Provide a brief description of the category.</p>
            </div>
          </div>
