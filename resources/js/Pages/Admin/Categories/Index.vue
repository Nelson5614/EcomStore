    ...
    <div class="p-4 sm:p-6">
      <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4 sm:mb-6">
        <div class="mb-4 sm:mb-0">
          <h1 class="text-xl sm:text-2xl font-bold text-gray-900">Categories Management</h1>
      ...
      <div class="bg-white shadow-lg rounded-lg overflow-hidden">
        <!-- Mobile Card View -->
        <div class="sm:hidden">
          <div v-for="category in categories" :key="category.id" class="border-b border-gray-200 p-4 hover:bg-gray-50">
            ...
            <div class="space-y-1">
              <p class="text-xs text-gray-600"><span class="font-medium">Slug:</span> {{ category.slug }}</p>
              <p class="text-xs text-gray-600"><span class="font-medium">Description:</span> {{ category.description || 'No description' }}</p>
          ...
          <div v-if="categories.length === 0" class="p-4 text-center text-sm text-gray-500">
            No categories found.
          </div>
        </div>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr v-for="category in categories" :key="category.id" class="hover:bg-gray-50">
                ...
                <td class="px-4 sm:px-6 py-4">
                  <div class="text-sm text-gray-500 max-w-xs truncate" :title="category.description || 'No description'">
      ...
      <div v-if="showDeleteModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
        <div class="relative top-10 sm:top-20 mx-auto p-4 sm:p-5 border w-11/12 sm:w-96 shadow-lg rounded-md bg-white">
          <div class="mt-3 text-center">
            ...
            <h3 class="text-base sm:text-lg leading-6 font-medium text-gray-900 mt-4">Delete Category</h3>
